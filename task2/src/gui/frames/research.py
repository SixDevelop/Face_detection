from tkinter import (BOTH, BOTTOM, E, HORIZONTAL, LEFT, TOP, Button, Canvas,
...
class ResearchFrame(Frame):
    ...
    # ======================= ПОСЛЕДОВАТЕЛЬНАЯ СИСТЕМА =======================
        ...
        # Запуск исследования
        self.run_but = Button(
            self.first_frame, text="Start", command=lambda: self.research()
        )
    ...
    # ======================= ОТОБРАЖЕНИЕ ГРАФИКОВ =======================
        ...
        self.canvas.create_window((200, 200), window=self, anchor=N + W)
    ...
    # ======================= Местоположение виджетов =======================
        ...
        self.hist_label.pack(padx=10, pady=7, anchor=W)
        self.hist_entry.pack(padx=10, pady=7, anchor=W)
        self.scale_label.pack(padx=10, pady=7, anchor=W)
        self.scale_entry.pack(padx=10, pady=7, anchor=W)
        self.gradient_label.pack(padx=10, pady=7, anchor=W)
        self.gradient_entry.pack(padx=10, pady=7, anchor=W)
        self.dft_label.pack(padx=10, pady=7, anchor=W)
        self.dft_entry.pack(padx=10, pady=7, anchor=W)
        self.dct_label.pack(padx=10, pady=7, anchor=W)
        self.dct_entry.pack( padx=10, pady=7, anchor=W)
        self.parallel_button.pack(padx=10, pady=7, anchor=W)

        # self.scroll_x.pack(side=BOTTOM, fill=X)
        self.canvas.pack(fill=BOTH, expand=True, anchor=E)
